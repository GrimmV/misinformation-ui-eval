...
<div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm w-full overflow-y-hidden">
	...
	<div class="overflow-x-auto overflow-y-hidden -mx-4 px-4" style="scrollbar-width: thin; scrollbar-color: #d1d5db #f3f4f6;">
		<div class="flex gap-3 pb-2 min-w-max">
			{#each Object.entries(features) as [featureName, feature]}
				<div 
					class="group relative flex-shrink-0 w-48 rounded-lg border border-gray-100 bg-gray-50 p-3 transition-all hover:border-gray-200 hover:shadow-sm"
					role="presentation"
					onmouseenter={(e) => {
