...
export { samplePosts } from './assets/postsData';
export type { SocialMediaPost as SocialMediaPostData } from './assets/postsData';
export { evaluationData, getEvaluationDataById } from './assets/evaluationData';
export type { EvaluationData } from './assets/evaluationData';
export { visualizationData, getVisualizationDataById } from './assets/visualizationData';
